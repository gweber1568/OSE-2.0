...
public class FenetrePrincipale extends JFrame implements Observateur  {
	...
	private void creerBarreMenus(){
		...
		JMenu menuPlan = new JMenu("Options") ;
...
//	}
	...
	public boolean saisirConfirmation(){
		int reply = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment purger le plan de salle ?", "Confirmer", JOptionPane.YES_NO_OPTION);
	...
	public String saisirNom(){
		String reply = JOptionPane.showInputDialog(null, "Veuillez saisir le nouveau nom du plan de salle :", "Nommer", JOptionPane.OK_OPTION) ;
		if (reply != ""){
			return reply ;
		}
		else {
